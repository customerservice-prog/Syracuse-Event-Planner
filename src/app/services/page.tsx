...
export default function ServicesPage() {
  const services = [
    {
      ...
      ic: 'text-rose-400',
      bg: 'from-rose-500/20',
      desc: 'From Skaneateles Lake to downtown Syracuse receptions.',
      features: ['20+ CNY venues', 'Vendor management', 'Custom design', 'Day-of coordination'],
    ...
    },
    {
      ...
      ic: 'text-blue-400',
      bg: 'from-blue-500/20',
      desc: 'Conferences and galas at Oncenter and beyond.',
      features: ['Conference planning', 'Annual galas', 'AV setup', 'Corporate catering'],
    ...
    },
    {
      ...
      desc: 'Birthdays, anniversaries, graduations — every milestone.',
      features: ['Theme design', 'Entertainment', 'Catering & bar', 'Photo booth'],
    ...
    },
    {
      ...
      ic: 'text-gold-400',
      bg: 'from-gold-500/20',
      desc: 'High-impact charity galas with silent auctions.',
      features: ['Full production', 'Auctions', 'Entertainment', 'Donor recognition'],
    ...
    },
    {
      ...
      desc: 'CNY photographers delivering stunning memories.',
      features: ['Event photography', 'Videography', 'Drone footage', 'Live streaming'],
    ...
    },
    {
      ...
      desc: 'Farm-to-table menus from top Syracuse caterers.',
      features: ['Menu curation', 'Dietary options', 'Premium bar', 'Craft beverages'],
  ...
  return (
    <div className="pt-24 pb-16">
      <section className="relative min-h-[50vh] flex items-center section-padding overflow-hidden">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-navy-950 via-navy-950/88 to-navy-950/65" />
        <div className="absolute inset-0 bg-gradient-to-t from-navy-950 to-transparent" />
        <div className="relative z-10 container-max text-center">
          <p className="text-gold-400 text-sm uppercase tracking-[0.2em] mb-3">What We Offer</p>
          ...
          <p className="text-white/60 text-xl mb-8 max-w-2xl mx-auto">
            Every detail handled — from Oncenter-scale productions to intimate lake-house weekends.
          </p>
          <Link
            href="/pricing"
      ...
      <section className="section-padding bg-navy-950">
        <div className="container-max space-y-20">
          {services.map(({ id, icon: Icon, title, ic, bg, desc, features, image }, i) => (
            <div key={id} id={id} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className={i % 2 === 1 ? 'lg:order-1' : ''}>
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${bg} to-transparent flex items-center justify-center mb-6`}
                >
                  <Icon className={`w-8 h-8 ${ic}`} />
                </div>
                <h2 className="font-display text-4xl font-bold text-white mb-4">{title}</h2>
                <p className="text-white/60 leading-relaxed mb-8 text-lg">{desc}</p>
                <Link
                  href="/pricing"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gold-500 text-navy-950 font-semibold hover:bg-gold-400 transition-all mb-8"
                >
                  ...
                  <ul className="space-y-3">
                    {features.map((f) => (
                      <li key={f} className="flex items-start gap-3">
                        <CheckCircle className={`w-5 h-5 ${ic} flex-shrink-0 mt-0.5`} />
